	...
	return (
		<div className='mr-4 bg-white mb-8 lg:mb-0 rounded-2xl py-12 px-8 flex flex-col  items-center justify-center'>
			...
			<div className='mt-3 flex items-center'>
				<button className='py-3 font-segoe-ui hover:cursor-pointer hover:bg-norm-black hover:border-none hover:text-white text-gray-800 font-semibold  border-2 border-gray-200 px-7 rounded-2xl text-sm'>
					Buy Crypto
				</button>
			</div>
		</div>
		...
		<div className='bg-gray-100'>
			<div className='px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
				<div className='container mx-auto'>
					...
					<p className='md:text-center text-left my-5 text-xl text-gray-500 font-dm-sans '>
