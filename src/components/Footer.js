    ...
    <div class="w-full px-6 py-4 mx-auto">
        <div class="lg:flex container mx-auto">
            <div class="w-full -mx-6 lg:w-2/5">
                <div class="px-6">
                    <div>
                        <a href="#" class="text-xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Bitcloud</a>
                    </div>
        ...
        <div>
            <p class="text-center text-gray-800 dark:text-white">© Bitcloud 2022 - All rights reserved</p>
        </div>
    </div>
</footer>
    )
