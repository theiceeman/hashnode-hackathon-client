						...
						<thead className='text-sm capitalize font-dm-sans mb-4 border-b-2 border-gray-100 text-gray-400'>
							<tr className='py-4'>
								<td className='p-2 whitespace-nowrap'>
									<div className='py-3 text-md tracking-wider font-dm-sans text-left'>#</div>
								</td>
								<td className='p-2 whitespace-nowrap'>
									<div className='py-3 text-md tracking-wider font-dm-sans text-left'>Name</div>
								</td>
								<td className='p-2 whitespace-nowrap'>
									<div className='py-3 text-md tracking-wider font-dm-sans text-left'>Price</div>
								</td>
								<td className='p-2 whitespace-nowrap'>
									<div className='py-3 text-md tracking-wider font-dm-sans text-left'>24h change</div>
								</td>
								<td className='p-2 whitespace-nowrap'>
									<div className='py-3 text-md tracking-wider font-dm-sans text-center'>Trade</div>
								</td>
							</tr>
						</thead>
